...
REM Date: 	 18th Feb 24
REM Purpose: To move all roms, bios / any copyrighted works back into the source for installation.
REM Usage:   Place in the root of the Roms folder downloaded from Mega.nz NOT in the github Source files.
REM Version: 0.1
REM ====================================

REM === Ask user for destination dir ===
@echo on
set /p directory="Enter path of Retrobat directory: "
echo %directory%
@echo off

REM ==== Move entire bios dir back into source===
move /Y "%~dp0bios" "%directory%"

REM === Create Roms\dos dir in destination ===
mkdir "%directory%\roms\dos"

REM === Move Dos Roms back into source ====
...
REM === Move Dreamcast Roms back into source ====
...
REM === Move MAME Roms (zip files) back into source ====
...
REM === Move mame folders back into source (these contain various bin/bios files etc) ===
...
REM === Move model3 Roms back into source ====
...
REM === Move naomi Roms back into source ====
...
REM === Move nes Roms back into source ====
...
REM === Move PS2 Roms back into source ====
...
REM === Move psx Roms back into source ====
...
REM === Move snes Roms back into source ====
...
REM === Move teknoparrot Roms back into source ====
...
REM === Move wii Roms back into source ====
...
REM === Move Windows Roms back into source ====
...
REM === Move xbox PS2 bios files back into source ====
move /Y "%~dp0roms\windows\PCSX2 1.6.0.pc\bios" "%directory%\roms\windows\PCSX2 1.6.0.pc"

REM === Move other files/folders back into PS2 emu source ====
...
REM === Move PS3 Roms back into source ====
...
REM === Move other files/folders back into PS3 emu source ====
...
REM === Move xbox Roms back into source ====
