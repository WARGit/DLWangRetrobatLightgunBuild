...
function Init()
	...
	RomConfig = lines_from("./artwork/crosshairs/hotd.cfg")
...
function Frame()
	I960_WriteDWord(TMAPGFXBASE+0x9220,0);
	I960_WriteDWord(TMAPGFXBASE+0x9224,0);
	I960_WriteDWord(TMAPGFXBASE+0x9228,0);
	I960_WriteDWord(TMAPGFXBASE+0x922C,0);
	I960_WriteDWord(TMAPGFXBASE+0x9230,0);
	I960_WriteDWord(TMAPGFXBASE+0x9234,0);
	I960_WriteDWord(TMAPGFXBASE+0x9238,0);
	I960_WriteDWord(TMAPGFXBASE+0x923C,0);
end
...
function End()
	--Save our Settings
	local file = io.open("./artwork/crosshairs/hotd.cfg", "w")
